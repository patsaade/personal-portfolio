    ...
    tools: [
      {
        ...
        commands: [{ desc: "List running processes from a memory image", cmd: "vol -f memory.dmp windows.pslist" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Mount a memory image as a live, browsable virtual file system", cmd: "MemProcFS.exe -device memory.dmp -mount m" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Create a case, add a disk image, and run all ingest modules headlessly", cmd: "autopsy64.exe --caseName=\"case1\" --caseBaseDir=\"C:\\work\\cases\" --addDataSource --runIngest --dataSourcePath=\"R:\\images\\evidence.img\"" }],
        references: [
      ...
      },
      {
        ...
        commands: [{ desc: "List all files (deleted and allocated) into a timeline bodyfile", cmd: "fls -r -m \"C:/\" image.dd > bodyfile.txt" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Extract a super-timeline from a disk image into a Plaso storage file", cmd: "log2timeline.py --storage-file timeline.plaso image.dd" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Import a Plaso timeline into a new Timesketch case", cmd: "timesketch import --name \"case1\" /path/to/timeline.plaso" }],
        references: [
      ...
      },
      {
        ...
        commands: [{ desc: "Launch the local GUI to query endpoints with VQL", cmd: "velociraptor.exe gui (Windows) / ./velociraptor gui (Linux/macOS)" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Filter a capture file to just HTTP traffic (tshark, the CLI companion)", cmd: "tshark -r capture.pcap -Y \"http\"" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Process a pcap file and generate Zeek's connection/protocol logs", cmd: "zeek -r capture.pcap" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Run Suricata against a pcap file in offline (no live capture) mode", cmd: "suricata -r capture.pcap -k none" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Capture and index a pcap file for search in the Arkime viewer", cmd: "/opt/arkime/bin/capture -c /opt/arkime/etc/config.ini -r /path/to/file.pcap" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Generate a CSV timeline of detections from a directory of EVTX logs", cmd: "hayabusa csv-timeline -d evtx_dir -o timeline.csv" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Hunt a directory of EVTX logs using Sigma rules", cmd: "chainsaw hunt evtx_dir -s sigma_rules --mapping mapping.yml" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Run headless analysis on a binary and execute a post-analysis script", cmd: "analyzeHeadless /project ProjectName -import binary.exe -postScript Script.java" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Open a binary with rizin's auto-analysis level 2", cmd: "cutter -A 2 suspicious.exe" }],
        references: [
      ...
      },
      {
        ...
        commands: [{ desc: "List the capabilities (behaviors) capa detects in a binary", cmd: "capa suspicious.exe" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Identify a file's type, packer, or compiler from the command line", cmd: "diec suspicious.exe" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Parse a Chrome profile's browser history and artifacts", cmd: "hindsight.py -i \"Chrome Profile Path\" -o output" }],
    ...
    tools: [
      {
        ...
        commands: [{ desc: "Collect a SANS Triage target set from the C: drive", cmd: "kape.exe --tsource C: --tdest D:\\Triage --target !SANS_Triage" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Parse a Windows Prefetch file with PECmd", cmd: "PECmd.exe -f Prefetch_File.pf" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Run WinDbg's built-in crash-analysis command on a loaded dump", cmd: "!analyze -v" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Start Process Monitor logging silently to a backing file", cmd: "procmon.exe /AcceptEula /Quiet /Minimized /Backingfile C:\\Logs\\trace.pml" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Install Sysmon with a custom configuration", cmd: "Sysmon64.exe -accepteula -i sysmonconfig.xml" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Image a physical drive to an E01 forensic image with case metadata", cmd: "ftkimager.exe \\\\.\\PHYSICALDRIVE1 D:\\Images\\case001 --e01 --case-number 001 --evidence-number 1" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Acquire a raw memory image from a live Windows system", cmd: "winpmem64.exe memory.raw" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Parse a SYSTEM registry hive with RegRipper's plugins", cmd: "rip.exe -r C:\\case\\SYSTEM -f system > output.txt" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Set a breakpoint on CreateFileW from the command bar", cmd: "bp CreateFileW (in the built-in command bar)" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Export browser history to an HTML report (BrowsingHistoryView)", cmd: "BrowsingHistoryView.exe /shtml \"C:\\report.html\" (most tools support /stext, /scomma, /sxml export switches)" }],
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [{ desc: "Look up all known open ports/services and banners for a host", cmd: "curl \"https://api.shodan.io/shodan/host/8.8.8.8?key=YOUR_API_KEY\"" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Check whether an IP is known internet background-scan noise (free Community API)", cmd: "curl https://api.greynoise.io/v3/community/8.8.8.8 -H \"key: YOUR_API_KEY\"" }],
      ...
      },
      {
        ...
        url: 'https://crt.sh/',
        commands: [{ desc: "Search Certificate Transparency logs for all certificates issued to a domain", cmd: "curl \"https://crt.sh/?q=example.com&output=json\"" }],
