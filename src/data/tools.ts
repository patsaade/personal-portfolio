...
export const TOOL_PLATFORMS: ToolPlatform[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [{ desc: "Scan a file against a YARA rule file", cmd: "yara rules.yar suspicious_file.exe" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Convert a Sigma rule into a Splunk query for the Sysmon log source", cmd: "sigma convert -t splunk -p sysmon rule.yml" }],
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [{ desc: "Scan every local drive for IOCs and YARA matches", cmd: "python loki.py -p C:\\ --alldrives" }],
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [{ desc: "Acquire Linux memory into a LiME-format image", cmd: "avml acquire output.lime" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Load LiME as a kernel module to dump memory to a mounted evidence share", cmd: "insmod lime.ko \"path=/mnt/evidence/mem.lime format=lime\"" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Run a triage-focused artifact collection profile", cmd: "./uac -p ir_triage /tmp" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Parse artifacts from a mounted macOS volume", cmd: "python3 mac_apt.py MOUNTED /mnt/root -o /output_dir FAST" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Run a deep incident-response collection on macOS", cmd: "sudo aftermath -o /Users/user/Desktop --deep" }],
      ...
      },
      {
        ...
        commands: [{ desc: "Parse macOS unified logs into readable records", cmd: "python3 UnifiedLogReader.py tracev3_folder uuidtext_folder timesync_folder output_path" }],
