...
export const TOOL_PLATFORMS: ToolPlatform[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        references: [{ name: 'Autopsy User\'s Guide (official docs)', url: 'https://sleuthkit.org/autopsy/docs/user-docs/4.0/' }],
      ...
      },
      {
        ...
        install: 'Self-hosted via the official deploy script, then docker compose up -d (see timesketch.org docs)',
        references: [{ name: 'GitHub Repository (source, releases, issues)', url: 'https://github.com/google/timesketch' }],
      ...
      },
      {
        ...
        references: [{ name: 'Cutter Official Documentation', url: 'https://cutter.re/docs/' }],
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        references: [{ name: 'SANS ISC Diary — Triaging Suspicious Files with PEStudio', url: 'https://isc.sans.edu/diary/22706' }],
